...
class RoutineListViewModel @Inject constructor(private val exampleRepository: ExampleRepository, private val db: RoutineDatabase) :
    BaseViewModel() {

    var routines = Transformations.map(db.routineDao.getAllRoutines()) {
        it.asDomainModel()
    }
